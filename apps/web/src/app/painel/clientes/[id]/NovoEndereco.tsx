...
export function NovoEndereco({ clienteId, fechar }: { clienteId: string; fechar: () => void }) {
  ...
  return (
    <div className="mb-6 grid gap-3 rounded-xl border-2 border-feltro/30 bg-white p-5 shadow-sm sm:grid-cols-3">
      ...
      <div className="flex gap-2 sm:col-span-3">
        ...
        <button onClick={fechar} className="rounded-lg border px-4 py-2 text-sm text-stone-500">Cancelar</button>
      </div>
    </div>
  );
}
