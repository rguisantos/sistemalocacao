  ...
  return (
    <main className="min-h-screen grid place-items-center bg-feltro">
      <div className="w-full max-w-sm rounded-xl bg-background p-8 shadow-2xl">
        ...
        <p className="mb-6 text-sm text-muted-foreground">Acesse com seu CPF e senha</p>

        <label className="mb-1 block text-sm font-medium">CPF</label>
        <input
          className="mb-4 w-full rounded-lg border border-border px-3 py-2 outline-none focus:ring-2 focus:ring-feltro"
          value={cpf}
